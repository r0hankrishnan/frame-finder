...
if __name__ == "__main__":
    ...
    CLEANED_DATA_PATH = (
        PARTIAL_SAVE_PATH / "racquets_cleaned_2026_06_24.csv"
    ...
    distilled_descs = distill_descriptions(
        racquets_df=racquets_df,
    ...
    with open(
        PARTIAL_SAVE_PATH / f"distilled_descriptions_{today_date}.csv", "w", newline=""
    ) as f:
