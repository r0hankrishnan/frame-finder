"""Module to create provider-agnostic adapters for use in description distillation and query parsing."""
...
class AnthropicAdapter(LLMAdapter):
    ...
    def complete(self, prompt: str, output_format: type[T]) -> T:
        ...
        ), "API call returned None. Something went wrong."
